...
class PyRanges:
    ...
    def __array_ufunc__(self, *args, **kwargs):
        ...
        |   (category) |   (int64) |   (int64) |   (int64) |   (int64) | (str)   |
        |--------------+-----------+-----------+-----------+-----------+---------|
        |            1 |         1 |         2 |         9 |       121 | n1      |
        |            2 |         2 |         3 |        16 |       144 | n2      |
        |            3 |         3 |         4 |        25 |       169 | n3      |
        ...
        +--------------+-----------+-----------+-------------+-------------+---------+
        |   Chromosome |     Start |       End |       Score |      Score2 | Name    |
        |   (category) |   (int64) |   (int64) |   (float64) |   (float64) | (str)   |
        |--------------+-----------+-----------+-------------+-------------+---------|
        |            1 |         1 |         2 |           3 |          11 | n1      |
        |            2 |         2 |         3 |           4 |          12 | n2      |
        |            3 |         3 |         4 |           5 |          13 | n3      |
    ...
    def __getitem__(self, val):
        ...
        | (category)   | (str)    | (category)   | (int64)   | (int64)   | (category)   | (str)           |
        |--------------+----------+--------------+-----------+-----------+--------------+-----------------|
    ...
    def boundaries(self, group_by, agg=None):
        ...
        |   (category) |   (int64) |   (int64) | (str)           | (str)   |   (int64) |
        |--------------+-----------+-----------+-----------------+---------+-----------|
        |            1 |         1 |        40 | tr1             | a       |        39 |
        |            1 |        60 |        68 | tr1             | b       |         8 |
        |            1 |       110 |       130 | tr2             | c       |        20 |
    ...
    def calculate_frame(self, by):
        ...
        |   (category) | (category)   |   (int64) |   (int64) | (str)           |
        |--------------+--------------+-----------+-----------+-----------------|
        |            1 | +            |         1 |        10 | t1              |
        |            1 | +            |        31 |        45 | t1              |
        |            1 | +            |        52 |        90 | t1              |
        ...
        |   (category) | (category)   |   (int64) |   (int64) | (str)           |   (int64) |
        |--------------+--------------+-----------+-----------+-----------------+-----------|
        |            1 | +            |         1 |        10 | t1              |         0 |
        |            1 | +            |        31 |        45 | t1              |         9 |
        |            1 | +            |        52 |        90 | t1              |        23 |
    ...
    def cluster(self, strand=None, by=None, slack=0, count=False, nb_cpu=1):
        ...
        | (category)   | (category)   | (str)         | (int64)   | (int64)   | (category)   | (int64)   |
        |--------------+--------------+---------------+-----------+-----------+--------------+-----------|
    ...
    def columns(self):
        ...
        >>> f2.columns
        Index(['Chromosome', 'Start', 'End', 'Name', 'Score', 'Strand'], dtype='str')
    ...
    def drop(self, drop=None, like=None):
        ...
        |   (category) |   (int64) |   (int64) | (category)   |   (int64) | (str)   |
        |--------------+-----------+-----------+--------------+-----------+---------|
        |            1 |         1 |         5 | +            |         1 | exon    |
        |            1 |         4 |         6 | -            |         2 | exon    |
        +--------------+-----------+-----------+--------------+-----------+---------+
    ...
    def join(
        ...
        | (category)   |   (int64) |   (int64) | (str)     |   (int64) |   (int64) | (str)    |
        |--------------+-----------+-----------+-----------+-----------+-----------+----------|
    ...
    def lengths(self, as_dict=False):
        ...
        | (category)   |   (int64) |   (int64) | (str)     |   (int64) | (category)   |   (int64) |
        |--------------+-----------+-----------+-----------+-----------+--------------+-----------|
    ...
    def merge(self, strand=None, count=False, count_col="Count", by=None, slack=0):
        ...
        | (category)   | (category)   | (int64)   | (int64)   | (category)   | (str)       |
        |--------------+--------------+-----------+-----------+--------------+-------------|
        ...
        | (category)   | (int64)   | (int64)   | (category)   | (category)   | (str)       | (int64)   |
        |--------------+-----------+-----------+--------------+--------------+-------------+-----------|
    ...
    def tile(self, tile_size, overlap=False, strand=None, nb_cpu=1):
        ...
        **kwargs
        ...
        | (category)   | (category)   | (int64)   | (int64)   | (category)   | (str)       | (int64)       |
        |--------------+--------------+-----------+-----------+--------------+-------------+---------------|
    ...
    def to_gff3(self, path=None, compression="infer", chain=False, map_cols=None):
        ...
        |   (category) |   (int64) |   (int64) | (str)     |   (int64) | (str)      |     (int64) | (str)   |
        |--------------+-----------+-----------+-----------+-----------+------------+-------------+---------|
